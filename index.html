    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          <a href="post.html">
            <h2 class="post-title">Premier jour en territoire hostile.
            </h2>
            <h3 class="post-subtitle">Des découvertes innattendues.            
            </h3>
          </a>
        ...
        <!-- Pager -->
        <div class="clearfix">
          <a class="btn btn-primary float-right" href="#">Précedents épisodes &rarr;</a>
        </div>
      </div>
    </div>
  </div>
